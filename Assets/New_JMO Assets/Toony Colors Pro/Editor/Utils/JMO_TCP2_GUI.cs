...
namespace JMOToonyColorsPro
{
	namespace Utilities
	{
		public static class JMO_TCP2_GUI
		{
			...
			{
				var rootDir = JMO_TCP2_Utils.FindReadmePath();
				if (rootDir == null)
				{
		...
		public class JMOTCP2HeaderHelpDecorator : MaterialPropertyDrawer
		{
			readonly string header;
			readonly string help;

			public JMOTCP2HeaderHelpDecorator(string header)
			{
				this.header = header;
				help = null;
			}
			public JMOTCP2HeaderHelpDecorator(string header, string help)
			{
				this.header = header;
				this.help = help;
			}
			...
			{
				JMO_TCP2_GUI.HeaderAndHelp(position, header, null, help, JMO_TCP2_GUI.OrangeBoldLabel);
			}
		...
		public class JMOTCP2HelpBoxDecorator : MaterialPropertyDrawer
		{
			...
			public JMOTCP2HelpBoxDecorator(string messageType, string msg)
			{
				msgType = (MessageType)Enum.Parse(typeof(MessageType), messageType);
				message = ParseMessage(msg);
				icon = JMO_TCP2_GUI.GetHelpBoxIcon(msgType);
			}

			public override void OnGUI(Rect position, MaterialProperty prop, string label, MaterialEditor editor)
			{
				position.height -= 4f;
				EditorGUI.LabelField(position, GUIContent.none, new GUIContent(message, icon), JMO_TCP2_GUI.HelpBoxRichTextStyle);
			...
			public override float GetPropertyHeight(MaterialProperty prop, string label, MaterialEditor editor)
			{
				...
				var height = JMO_TCP2_GUI.HelpBoxRichTextStyle.CalcHeight(new GUIContent(message, icon), Screen.width - (scrollBar ? 51 : 34));
				return height + 6f;
			}
		}
		...
		public class JMOTCP2SeparatorDecorator : MaterialPropertyDrawer
		{
			public override void OnGUI(Rect position, MaterialProperty prop, string label, MaterialEditor editor)
			{
				position.y += 4;
				position.height -= 4;
				JMO_TCP2_GUI.Separator(position);
			}
		...
		public class JMOTCP2OutlineNormalsGUIDrawer : MaterialPropertyDrawer
		{
			...
			public override void OnGUI(Rect position, MaterialProperty prop, string label, MaterialEditor editor)
			{
				JMO_TCP2_GUI.Header("Outline Normals Source", "Defines where to take the vertex normals from to draw the outline.\nChange this when using a smoothed mesh to fill the gaps shown in hard-edged meshes.");

				var r = EditorGUILayout.GetControlRect();
				r = EditorGUI.IndentedRect(r);
				var index = GetCurrentIndex(prop);
				EditorGUI.BeginChangeCheck();
				index = JMO_TCP2_GUI.RadioChoiceHorizontal(r, index, labels);
		...
		public class JMOTCP2Vector4FloatsDrawer : MaterialPropertyDrawer
		{
			...
			public JMOTCP2Vector4FloatsDrawer(string labelX, string labelY, string labelZ, string labelW)
			{
			...
			public JMOTCP2Vector4FloatsDrawer(string labelX, string labelY, string labelZ, string labelW, float minX, float maxX, float minY, float maxY, float minZ, float maxZ, float minW, float maxW)
			{
				labels = new[] { labelX, labelY, labelZ, labelW };
		...
		public class JMOTCP2Vector3FloatsDrawer : JMOTCP2Vector4FloatsDrawer
		{
			public JMOTCP2Vector3FloatsDrawer(string labelX, string labelY, string labelZ) : base(labelX, labelY, labelZ, "")
			{
				channelsCount = 3;
			}

			public JMOTCP2Vector3FloatsDrawer(string labelX, string labelY, string labelZ, float minX, float maxX, float minY, float maxY, float minZ, float maxZ)
		...
		public class JMOTCP2ColorNoAlphaDrawer : MaterialPropertyDrawer
		{
			readonly bool forceHdr;
			
			public JMOTCP2ColorNoAlphaDrawer() { }
			public JMOTCP2ColorNoAlphaDrawer(string hdr)
			{
		...
		public class JMOTCP2GradientDrawer : MaterialPropertyDrawer
		{
			...
			public override void OnGUI(Rect position, MaterialProperty prop, string label, MaterialEditor editor)
			{
				...
				GUI.enabled = false;
				GUI.Button(buttonRect, "Create New", EditorStyles.miniButtonLeft);
				GUI.enabled = enabled;
			...
			{
				var rampGeneratorType = FindType("JMOToonyColorsPro.TCP2_RampGenerator");
		...
		public class JMOTCP2HeaderDecorator : MaterialPropertyDrawer
		{
			protected readonly string header;

			public JMOTCP2HeaderDecorator(string header)
			{
				this.header = header;
			}
			...
			public override void OnGUI(Rect position, MaterialProperty prop, string label, MaterialEditor editor)
			{
				JMO_TCP2_GUI.Header(position, header);
			}
		...
		public class JMOTCP2KeywordFilterDrawer : MaterialPropertyDrawer
		{
			protected readonly string[] keywords;

			public JMOTCP2KeywordFilterDrawer(string keyword)
			{
		...
		internal class JMOTCP2ToggleNoKeywordDrawer : MaterialPropertyDrawer
		{
		...
		internal class JMOTCP2HeaderToggleDrawer : MaterialPropertyDrawer
		{
			protected readonly string keyword;

			public JMOTCP2HeaderToggleDrawer()
			{
				keyword = null;
			}

			public JMOTCP2HeaderToggleDrawer(string keyword)
			{
			...
			public override void OnGUI(Rect position, MaterialProperty prop, GUIContent label, MaterialEditor editor)
			{
				...
				Rect toggleRect = EditorGUI.PrefixLabel(position, label, JMO_TCP2_GUI.OrangeBoldLabel);
				GUI.color = guiColor;
		...
		internal class JMOTCP2MaterialKeywordEnumNoPrefixDrawer : MaterialPropertyDrawer
		{
			private readonly GUIContent[] labels;
			private readonly string[] keywords;

			public JMOTCP2MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1) : this(new[] { lbl1 }, new[] { kw1 }) { }
			public JMOTCP2MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2) : this(new[] { lbl1, lbl2 }, new[] { kw1, kw2 }) { }
			public JMOTCP2MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3, string kw3) : this(new[] { lbl1, lbl2, lbl3 }, new[] { kw1, kw2, kw3 }) { }
			public JMOTCP2MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3, string kw3, string lbl4, string kw4) : this(new[] { lbl1, lbl2, lbl3, lbl4 }, new[] { kw1, kw2, kw3, kw4 }) { }
			public JMOTCP2MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3, string kw3, string lbl4, string kw4, string lbl5, string kw5) : this(new[] { lbl1, lbl2, lbl3, lbl4, lbl5 }, new[] { kw1, kw2, kw3, kw4, kw5 }) { }
			public JMOTCP2MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3, string kw3, string lbl4, string kw4, string lbl5, string kw5, string lbl6, string kw6) : this(new[] { lbl1, lbl2, lbl3, lbl4, lbl5, lbl6 }, new[] { kw1, kw2, kw3, kw4, kw5, kw6 }) { }
			public JMOTCP2MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3, string kw3, string lbl4, string kw4, string lbl5, string kw5, string lbl6, string kw6, string lbl7, string kw7) : this(new[] { lbl1, lbl2, lbl3, lbl4, lbl5, lbl6, lbl7 }, new[] { kw1, kw2, kw3, kw4, kw5, kw6, kw7 }) { }
			public JMOTCP2MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3, string kw3, string lbl4, string kw4, string lbl5, string kw5, string lbl6, string kw6, string lbl7, string kw7, string lbl8, string kw8) : this(new[] { lbl1, lbl2, lbl3, lbl4, lbl5, lbl6, lbl7, lbl8 }, new[] { kw1, kw2, kw3, kw4, kw5, kw6, kw7, kw8 }) { }

			public JMOTCP2MaterialKeywordEnumNoPrefixDrawer(string[] labels, string[] keywords)
			{
		...
		internal class MaterialJMOTCP2EnumDrawer : MaterialPropertyDrawer
		{
			private readonly GUIContent[] names;
			private readonly float[] values;

			public MaterialJMOTCP2EnumDrawer(string n1, float v1) : this(new string[] { n1 }, new float[] { v1 }) { }
			public MaterialJMOTCP2EnumDrawer(string n1, float v1, string n2, float v2) : this(new string[] { n1, n2 }, new float[] { v1, v2 }) { }
			public MaterialJMOTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3) : this(new string[] { n1, n2, n3 }, new float[] { v1, v2, v3 }) { }
			public MaterialJMOTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4, float v4) : this(new string[] { n1, n2, n3, n4 }, new float[] { v1, v2, v3, v4 }) { }
			public MaterialJMOTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4, float v4, string n5, float v5) : this(new string[] { n1, n2, n3, n4, n5 }, new float[] { v1, v2, v3, v4, v5 }) { }
			public MaterialJMOTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4, float v4, string n5, float v5, string n6, float v6) : this(new string[] { n1, n2, n3, n4, n5, n6 }, new float[] { v1, v2, v3, v4, v5, v6 }) { }
			public MaterialJMOTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4, float v4, string n5, float v5, string n6, float v6, string n7, float v7) : this(new string[] { n1, n2, n3, n4, n5, n6, n7 }, new float[] { v1, v2, v3, v4, v5, v6, v7 }) { }
			public MaterialJMOTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4, float v4, string n5, float v5, string n6, float v6, string n7, float v7, string n8, float v8) : this(new string[] { n1, n2, n3, n4, n5, n6, n7, n8 }, new float[] { v1, v2, v3, v4, v5, v6, v7, v8 }) { }
			public MaterialJMOTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4, float v4, string n5, float v5, string n6, float v6, string n7, float v7, string n8, float v8, string n9, float v9) : this(new string[] { n1, n2, n3, n4, n5, n6, n7, n8, n9 }, new float[] { v1, v2, v3, v4, v5, v6, v7, v8, v9 }) { }
			public MaterialJMOTCP2EnumDrawer(string n1, float v1, string n2, float v2, string n3, float v3, string n4, float v4, string n5, float v5, string n6, float v6, string n7, float v7, string n8, float v8, string n9, float v9, string n10, float v10) : this(new string[] { n1, n2, n3, n4, n5, n6, n7, n8, n9, n10 }, new float[] { v1, v2, v3, v4, v5, v6, v7, v8, v9, v10 }) { }
			...
			public MaterialJMOTCP2EnumDrawer(string[] enumNames, float[] vals)
			{
		...
		internal class JMOTCP2TextureSingleLine : MaterialPropertyDrawer
		{
			private static bool IsPropertyTypeSuitable(MaterialProperty prop)
			{
#if UNITY_6000_1_OR_NEWER
		...
		internal class JMOTCP2UVScrolling : MaterialPropertyDrawer
		{
