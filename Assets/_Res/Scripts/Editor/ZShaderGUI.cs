...
public sealed class ZShaderGUI : ShaderGUI
{
    ...
    private static void DrawMaterialProperties(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        DrawTextureSection(materialEditor, properties, "Emission", "Emission", "_EmissionMap", "_EmissionColor");
        DrawProperty(materialEditor, properties, "_EmissionStrength");

        DrawSection("Rim Lighting");
    ...
    private static void DrawAlbedoHSVProperties(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        if (FindProperty("_AlbedoHSV_H", properties, false) == null)
            return;

        DrawSection("Albedo HSV");
        DrawProperty(materialEditor, properties, "_AlbedoHSV_H");
        DrawProperty(materialEditor, properties, "_AlbedoHSV_S");
        DrawProperty(materialEditor, properties, "_AlbedoHSV_V");
    }
        ...
        bool drawScaleOffset = true)
    {
        ...
        if (hasColor)
        {
            ...
            bool hdr = (color.flags & MaterialProperty.PropFlags.HDR) == MaterialProperty.PropFlags.HDR;
            EditorGUI.LabelField(colorLabelRect, "Color");
            color.colorValue = EditorGUI.ColorField(colorRect, GUIContent.none, color.colorValue, true, true, hdr);
        }
