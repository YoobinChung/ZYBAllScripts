...
Shader "JMO Toony Colors Pro 2/Hybrid Shader 2 Standalone URP Outline"
{
	Properties
	{
	...
	//# Base
		...
		[Enum(UV1,0,UV2,1,UV3,2)] _BaseUV ("Albedo UV Set", Float) = 0
		_TCP2AlbedoHSV_H ("Albedo Hue", Range(-180,180)) = 0
	...
	//# END_IF
	//# 
		[JMOTCP2MaterialKeywordEnumNoPrefix(Normal, _, Vertex Colors, TCP2_COLORS_AS_NORMALS, Tangents, TCP2_TANGENT_AS_NORMALS, UV1, TCP2_UV1_AS_NORMALS, UV2, TCP2_UV2_AS_NORMALS, UV3, TCP2_UV3_AS_NORMALS, UV4, TCP2_UV4_AS_NORMALS, Object Position, TCP2_OBJECT_POS_AS_NORMALS)]
	...
	SubShader
	{
		...
		Pass
		{
			...
			// -------------------------------------
			// Toony Colors Pro 2 keywords
			#pragma shader_feature_local _ TCP2_COLORS_AS_NORMALS TCP2_TANGENT_AS_NORMALS TCP2_UV1_AS_NORMALS TCP2_UV2_AS_NORMALS TCP2_UV3_AS_NORMALS TCP2_UV4_AS_NORMALS TCP2_OBJECT_POS_AS_NORMALS
			...
			#pragma shader_feature_local_fragment _ TCP2_SHADOW_TEXTURE
		...
		Pass
		{
			...
			Varyings_Shadow ShadowPassVertex(Attributes_Shadow input)
			{
				...
				float2 baseUv = TCP2_SelectUv(_BaseUV, input.texcoord, input.texcoord1, input.texcoord2);
				output.uv = baseUv * _BaseMap_ST.xy + _BaseMap_ST.zw;
