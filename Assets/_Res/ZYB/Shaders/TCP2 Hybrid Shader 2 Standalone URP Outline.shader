...
Shader "Toony Colors Pro 2/Hybrid Shader 2 Standalone URP Outline"
{
	Properties
	{
	...
	//# END_IF
	//# 
		[TCP2MaterialKeywordEnumNoPrefix(Normal, _, Vertex Colors, TCP2_COLORS_AS_NORMALS, Tangents, TCP2_TANGENT_AS_NORMALS, UV1, TCP2_UV1_AS_NORMALS, UV2, TCP2_UV2_AS_NORMALS, UV3, TCP2_UV3_AS_NORMALS, UV4, TCP2_UV4_AS_NORMALS, Object Position, TCP2_OBJECT_POS_AS_NORMALS)]
